...
<body class="lg:w-3/4 mx-auto">
    ...
    <header class="relative aspect-[21/9]">
        ...
        <img src="/src/pages/ch1yoCoffee/images/1.jpg" alt="" class="w-full h-full object-cover opacity-50">
        ...
        <section class="h-[600px] swiper-wrapper" id="about" >
            <div class="bg-amber-100 lg:w-[900px] w-10/12 h-full  mx-auto flex flex-wrap items-center swiper-slide">
                <div class="lg:w-1/3 sm:w-1/2 w-full p-10 aspect-[16/9]">
                    <div class="rounded-full overflow-hidden aspect-[1/1]">
                        <img src="/src/pages/ch1yoCoffee/images/4.jpg" alt="" class="w-full h-full object-cover">
                    </div>
                </div>
            ...
            <div class="lg:w-[900px] w-10/12 items-center swiper-slide">
                <div class="sm:aspect-[16/9] aspect-[1/1]">
                    <img src="/src/pages/ch1yoCoffee/images/p10.jpg" alt="" class="w-full h-full object-cover">
                </div>
            </div>
            <div class="lg:w-[900px] w-10/12 items-center swiper-slide">
                <div class="sm:aspect-[16/9] aspect-[1/1]">
                    <img src="/src/pages/ch1yoCoffee/images/11.jpg" alt="" class="w-full h-full object-cover">
                </div>
            </div>
            ...
            <div class="w-full xl:w-1/3">
                <a href="/images/p9.jpg" class="block">
                    <figure class="relative overflow-hidden aspect-[3/4]" data-aos="zoom-in"
                        data-aos-anchor-placement="center-bottom" data-aos-delay="100">
                        <img src="/src/pages/ch1yoCoffee/images/p9.jpg" alt="" class="object-cover">
                        <figcaption
            ...
            <div class="flex flex-wrap xl:w-2/3">
                <div class="xl:w-1/6,h-1/2, lg:w-1/4 sm:w-1/3 w-1/2" data-aos="zoom-in"
                    ...
                    <a href="/images/p1.jpg" class="block">
                        <figure class="relative overflow-hidden aspect-[3/4]">
                            <img src="/src/pages/ch1yoCoffee/images/p1.jpg" alt="" class="object-contain">
                            <figcaption
                                class="absolute bottom-0 bg-amber-200/50 w-full text-center translate-y-full duration-500 italic">
                                讀本書吧!</figcaption>
                        </figure>
                ...
                <div class="xl:w-1/6,h-1/2 lg:w-1/4 sm:w-1/3 w-1/2" data-aos="zoom-in"
                    ...
                    <a href="/images/p2.jpg" class="block">
                        <figure class="relative overflow-hidden aspect-[3/4]">
                            <img src="/src/pages/ch1yoCoffee/images/p2.jpg" alt="" class="object-cover">
                            <figcaption
                                class="absolute bottom-0 bg-amber-200/50 w-full text-center translate-y-full duration-500 italic">
                                冰拿鐵</figcaption>
                        </figure>
                ...
                <div class="xl:w-1/6,h-1/2 lg:w-1/4 sm:w-1/3 w-1/2" data-aos="zoom-in"
                    ...
                    <a href="/images/p3.jpg" class="block">
                        <figure class="relative overflow-hidden aspect-[3/4]">
                            <img src="/src/pages/ch1yoCoffee/images/p3.jpg" alt="" class="object-cover">
                            <figcaption
                                class="absolute bottom-0 bg-amber-200/50 w-full text-center translate-y-full duration-500 italic">
                                濃縮咖啡</figcaption>
                        </figure>
                ...
                <div class="xl:w-1/6,h-1/2 lg:w-1/4 sm:w-1/3 w-1/2" data-aos="zoom-in"
                    ...
                    <a href="/images/p4.jpg" class="block">
                        <figure class="relative overflow-hidden aspect-[3/4]">
                            <img src="/src/pages/ch1yoCoffee/images/p4.jpg" alt="" class="object-cover">
                            <figcaption
                                class="absolute bottom-0 bg-amber-200/50 w-full text-center translate-y-full duration-500 italic">
                                巧克力布郎尼</figcaption>
                        </figure>
                ...
                <div class="xl:w-1/6,h-1/2 lg:w-1/4 sm:w-1/3 w-1/2" data-aos="zoom-in"
                    ...
                    <a href="/images/p5.jpg" class="block">
                        <figure class="relative overflow-hidden aspect-[3/4]">
                            <img src="/src/pages/ch1yoCoffee/images/p5.jpg" alt="" class="object-cover">
                            <figcaption
                                class="absolute bottom-0 bg-amber-200/50 w-full text-center translate-y-full duration-500 italic">
                                特色咖啡</figcaption>
                        </figure>
                ...
                <div class="xl:w-1/6,h-1/2 lg:w-1/4 sm:w-1/3 w-1/2" data-aos="zoom-in"
                    ...
                    <a href="/images/p6.jpg" class="block">
                        <figure class="relative overflow-hidden aspect-[3/4]">
                            <img src="/src/pages/ch1yoCoffee/images/p6.jpg" alt="" class="object-cover">
                            <figcaption
                                class="absolute bottom-0 bg-amber-200/50 w-full text-center translate-y-full duration-500 italic">
                                來個糕點吧!</figcaption>
                        </figure>
                ...
                <div class="xl:w-1/6,h-1/2 lg:w-1/4 sm:w-1/3 w-1/2" data-aos="zoom-in"
                    ...
                    <a href="/images/p7.jpg" class="block">
                        ...
                        <figure class="relative overflow-hidden aspect-[3/4]">
                            <img src="/src/pages/ch1yoCoffee/images/p7.jpg" alt="" class="object-cover">
                            <figcaption
                                class="absolute bottom-0 bg-amber-200/50 w-full text-center translate-y-full duration-500 italic">
                                來個糕點吧!</figcaption>
                        </figure>
                ...
                <div class="xl:w-1/6,h-1/2 lg:w-1/4 sm:w-1/3 w-1/2" data-aos="zoom-in"
                    ...
                    <a href="/images/p8.jpg" class="block">
                        ...
                        <figure class="relative overflow-hidden aspect-[3/4]">
                            <img src="/src/pages/ch1yoCoffee/images/p8.jpg" alt="" class="object-cover">
                            <figcaption
                                class="absolute bottom-0 bg-amber-200/50 w-full text-center translate-y-full duration-500 italic">
                                朋友聚餐</figcaption>
                        </figure>
